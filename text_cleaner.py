...
class TextCleaner:
    ...
    def __init__(self):
        ...
        self.punctuation = string.punctuation   # Replace None with the correct code(DONE)
    ...
    def clean_text(self, text):
        ...
        text = text.lower()  # Replace None with the correct code (DONE)
        ...
        text = re.sub(r'[^a-z0-9\s]','',text)  # Replace None with: re.sub(r'[^a-z0-9\s]', '', text) (DONE)
    ...
    def tokenize(self, text):
        ...
        cleaned = self.clean_text(text)  # Replace None with the correct code (DONE)
        
        # TODO: Split the cleaned text into a list of words
        # Hint: Use the .split() method (splits on whitespace by default)
        tokens = cleaned.split()  # Replace None with the correct code (DONE)
    ...
    def get_word_count(self, text):
        ...
        tokens = self.tokenize(text)  # Replace None with the correct code(DONE)
        return len(tokens)  # Replace None with: len(tokens) (DONE)

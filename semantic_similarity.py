...
class SemanticSimilarity:
    ...
    def cosine_similarity(self, vec1: List[float], vec2: List[float]) -> float:
        ...
        dot_product = sum(a * b for a, b in zip(vec1, vec2))  # Replace None with the correct code (DONE)
        ...
        magnitude1 = math.sqrt(sum(a * a for a in vec1))  # Replace None with the correct code (DONE)
        
        # TODO: Step 3 - Calculate magnitude of vec2 (||B||)
        # Hint: Square each element, sum them, then take square root
        # Use: math.sqrt(sum(b * b for b in vec2))
        magnitude2 = math.sqrt(sum(b * b for b in vec2))  # Replace None with the correct code (DONE)
        ...
        similarity = dot_product/(magnitude1*magnitude2)  # Replace None with the correct code (DONE)
    ...
    def interpret_similarity(self, score: float) -> str:
        ...
        if score >= 0.9:
            return "Nearly identical!"  # Replace None with: "Nearly identical!" (DONE)
        elif score >= 0.7:
            return "Very similar"  # Replace None with: "Very similar" (DONE)
        elif score >= 0.5:
            return "Somewhat similar"  # Replace None with: "Somewhat similar" (DONE)
        elif score >= 0.3:
            return "A bit related" # Replace None with: "A bit related" (DONE)
        else:
            return "Quite different"  # Replace None with: "Quite different"(DONE)
    ...
    def compare_multiple(self, base_vec: List[float], compare_vecs: dict) -> dict:
        ...
        for name, vec in compare_vecs.items():
            ...
            similarity = self.cosine_similarity(base_vec,vec)  # Replace None with the correct code (DONE)
        ...
        sorted_results = dict(sorted(results.items(), key=lambda x: x[1], reverse=True))  # Replace None with: dict(sorted(results.items(), key=lambda x: x[1], reverse=True)) (DONE)
